                ...
                <div className="flex items-center relative border border-gray-300 hover:bg-gray-200 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-300 rounded-md overflow-hidden">
                    <Popover modal>
                        <PopoverTrigger asChild>
                            <button className="flex cursor-pointer bg-transparent items-center gap-2 rounded-md px-2 py-1 text-sm font-medium text-gray-600 hover:bg-gray-200 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-300">
